...
## 7. Routing and Language Features (v1.0.3)

Tools MAY declare routing and language support under "features".
...
```json
{
  "features": {
    "routing": {
      "supported": true,
      "entrypoints": ["describe routing", "describe guides"],
...
- routing.supported (boolean)
- routing.entrypoints (array of describe topics or mechanisms)
- routing.selectors (array of filtering axes)
- routing.fallback_search (boolean)
- languages.available (array of BCP 47 codes)
- languages.default (object describing default language per audience)

Unknown fields MUST be ignored by consumers.

---------------------------------------------------------------------

End of schema v1.0.3 extension.
