# IdeaMark YAML Specification v1.0.3
...
## 13. Evidence YAML Handling（v1.0.3）
...
This version introduces no structural schema changes.
All modifications are documentation-level clarifications
regarding routing-oriented use of `anchorage.domain`
and multi-language guidance handling.

Schema remains fully backward compatible with v1.0.2.
