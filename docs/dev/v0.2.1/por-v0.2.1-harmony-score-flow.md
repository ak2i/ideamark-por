# POR v0.2.1 Hypothesis — Harmony Score Integrated Flow

Status: hypothesis for design discussion
Baseline: `docs/dev/v0.2.1/por-v0.2.1-planning.md`
...
POR v0.2.1 redefines POR as a Knowledge Reconstruction Front-end rather than a
...
In v0.2.1, Harmony-related raw data may remain in POR session artifacts:
...
2. What is the minimum component set for v0.2.1 experiments?
...
For v0.2.1, the recommended working position is:
